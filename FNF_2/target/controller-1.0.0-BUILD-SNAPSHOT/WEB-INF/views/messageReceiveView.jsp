...
<h1 style="text-align:center;margin-top: 0px;margin-bottom: 20px;">받은 메시지 확인</h1>
...
<!-- 				<button type="button" id="btnSend" class="btn btn-success">답장</button>&nbsp;&nbsp; -->
				<a href="../remessage/${msg.idx}"><button type="button" id="btnSend" class="btn btn-success">답장</button></a>&nbsp;&nbsp;
